export default function Confirmation() {
  return (
    <div className="px-[24px] py-[80px] lg:grow-[1] lg:overflow-y-auto lg:px-[0] lg:py-[auto]">
      <svg
        className="mx-auto aspect-square w-[56px]"
      ...
      <h1 className="text-center text-[1.625rem] font-bold text-marine-blue lg:text-[2rem]">
        Thank you!
      </h1>
      <p className="mt-[8px] break-words text-center text-[1.125rem] text-cool-gray">
